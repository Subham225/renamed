...
const cmd = `curl -s -X POST https://api.phonepe.com/apis/pg/v1/pay -H 'Content-Type: application/json' -H 'X-VERIFY: ${sig}' -H 'X-MERCHANT-ID: ${merchantId}' -d '{"request":"${base64Payload}"}' -w "\n%{http_code}"`;
